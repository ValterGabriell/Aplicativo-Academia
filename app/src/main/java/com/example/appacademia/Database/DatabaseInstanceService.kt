...
@Database(entities = [DataEntity::class], version = 3)
abstract class DatabaseInstanceService : RoomDatabase() {
    ...
    companion object{
        ...
        private fun createDatabase(context: Context) : DatabaseInstanceService =
            Room.databaseBuilder(context, DatabaseInstanceService::class.java, DATABASE_NAME).allowMainThreadQueries().build()
